...
/*
* Likwise strategy, template emthod leverages that an algorithm's implementation can be structured in 2 parts:
...
* some geenric logic implemented which invokes specific logic. This specific logic is a pure virtual method of the

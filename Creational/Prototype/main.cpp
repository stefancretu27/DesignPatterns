ing#include "PrototypeInnerFactory.hpp"
...
*
* Implementation-wise, in its simplest form, involves using a CreatWithPrototype method, which reuses an existing member object
* constructed for previous instances, or in previous operations, and which can take additional input arguments, when calling
* the prototyped class' ctor, returning the such created instance.
* 
